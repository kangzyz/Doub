...
const BASE_MARKDOWN_CLASSNAME = cn(
  ...
  "[&_[data-streamdown='code-block-body']_pre]:!rounded-none [&_[data-streamdown='code-block-body']_pre]:!border-0 [&_[data-streamdown='code-block-body']_pre]:!bg-transparent [&_[data-streamdown='code-block-body']_pre]:!p-0 [&_[data-streamdown='code-block-body']_pre]:!pb-2",
