...
<p align="center">
  <a href="https://doub.vexown.com"><img alt="官网" src="https://img.shields.io/badge/官网-doub.vexown.com-black" /></a>
...
DOUB Chat 为团队提供统一的 AI 工作台，用一个清晰的使用入口承载多个上游模型和服务商。它将多模态对话、模型路由、文件与 RAG、MCP 工具、用量计费、身份认证、审计日志和运维控制整合到同一个产品中。
