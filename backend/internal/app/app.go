...
import (
	...
	"github.com/kangzyz/Doub/backend/internal/application/memory"
	...
	apprag "github.com/kangzyz/Doub/backend/internal/application/rag"
	appruntime "github.com/kangzyz/Doub/backend/internal/application/runtime"
	"github.com/kangzyz/Doub/backend/internal/application/settings"
	appsystemevent "github.com/kangzyz/Doub/backend/internal/application/systemevent"
	"github.com/kangzyz/Doub/backend/internal/application/user"
	"github.com/kangzyz/Doub/backend/internal/application/usersettings"
	platformcache "github.com/kangzyz/Doub/backend/internal/infra/cache/redis"
	"github.com/kangzyz/Doub/backend/internal/infra/config"
	"github.com/kangzyz/Doub/backend/internal/infra/embedding"
	"github.com/kangzyz/Doub/backend/internal/infra/geoip"
	...
	memoryrepo "github.com/kangzyz/Doub/backend/internal/infra/persistence/postgres/memory"
	settingsrepo "github.com/kangzyz/Doub/backend/internal/infra/persistence/postgres/settings"
	systemeventrepo "github.com/kangzyz/Doub/backend/internal/infra/persistence/postgres/systemevent"
	userrepo "github.com/kangzyz/Doub/backend/internal/infra/persistence/postgres/user"
	usersettingsrepo "github.com/kangzyz/Doub/backend/internal/infra/persistence/postgres/usersettings"
	...
	memoryhttp "github.com/kangzyz/Doub/backend/internal/transport/http/memory"
	settingshttp "github.com/kangzyz/Doub/backend/internal/transport/http/settings"
	usersettingshttp "github.com/kangzyz/Doub/backend/internal/transport/http/usersettings"
	"go.uber.org/zap"
	"gorm.io/gorm"
)
